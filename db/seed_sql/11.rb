...
description = <<-TEXT
  ...
  Создайте представление **random_aircrafts**, которое каждый раз возвращает пять случайных и различных моделей самолётов.
  Предполагается, что в таблице есть повторяющиеся (по названию) модели.
  Повторения выводить не надо (т.е. пять различных между собой).
TEXT
