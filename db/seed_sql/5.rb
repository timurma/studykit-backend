...
description = <<-TEXT
  Мы хотим указать внешние ссылки.
  Но для быстрого поиска пассажира по номеру его паспорта надо сделать индекс по этому полю.
  Сделайте такой индекс с именем **passport_number_idx**.
  Пустые (NULL) значения включать в индекс не нужно.
TEXT
