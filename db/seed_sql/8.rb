...
description = <<-TEXT
  ...
  Выберите города и количество рейсов, которые должны были прибыть туда за пять дней,
    с 10 сентября 2016 00:00:00 по 15 сентября 00:00:00.
  Упорядочите результат по количеству рейсов.
