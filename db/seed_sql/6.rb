...
description = <<-TEXT
Теперь укажем ссылки в столбец **passenger_ref**. При этом, на всякий случай, для тех пассажиров, которых мы уже обновили, запишем "*OK*" вместо номера паспорта **passenger_id**.
