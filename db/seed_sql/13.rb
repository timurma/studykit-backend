...
description = <<-TEXT
  ...
  Наверняка многие из вас писали рекурсивные алгоритмы на Паскале или Си.
  Но сегодня задача ещё интереснее!
  Напишите рекурсивное (если точнее, итеративный алгоритм вычисления при помощи рекурсивного запроса) вычисление n-го числа Фибоначчи.
  Оформите его в виде хранимой процедуры, котрорая вызывает SQL-запрос.
