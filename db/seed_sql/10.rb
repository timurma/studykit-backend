...
description = <<-TEXT
  ...
  Напишите скрипт, который в транзакции с уровнем изоляции **READ COMMITTED** увеличит значение **attr** в два раза.
  При этом надо иметь в виду, что другие клиенты базы данных также могут работать с этой таблицей.
TEXT
