...
description = <<-TEXT
  Данные мы перенесли.
  Но, если один пассажир бронировал несколько билетов, в таблице **passengers** есть дубликаты.
  Их необходимо удалить.
  Отличить повторяющиеся записи можно по совпадающим **passport_number**.
TEXT
