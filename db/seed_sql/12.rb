...
description = <<-TEXT
  ...
  Создайте тригер, который перед обновлением в таблице **boarding_passes** столбца **seat_no**,
    если значение изменилось на **NULL**, удаляет соответствующую строку из таблицы.
  Сохраните **boarding_no** из удаляемой строки.
